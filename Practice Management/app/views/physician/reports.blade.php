...
//                startDate: "1d",
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.response == 'false') {
                            ...
                            url = '?hospital_id=' + $('#selectHospital2').val() + '&clinic_id=' + $('#selectClinic2').val()
                                    + '&physician_id=' + $('#selectPhysician2').val() + '&from_date=' + $('#from_date').val() +
                                    '&to_date=' + $('#to_date').val();
            ...
            $("#download_excel").click(function (e) {
                ...
                window.location.href = '{{route('excelPhysicianReport')}}?' + jQuery.param(urlParams);
            });
...
@section('content')
    ...
    <section class="content">
        <div class="row" id="withMe">
            ...
            @if($c_user->user_type_id == 1 || $c_user->hasAccess('physician.report_excel'))
